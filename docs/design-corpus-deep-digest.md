...
description: auto-v5 (686 design) + auto-v6 (139 design) = 824 篇深读索引；15 篇综合覆盖约 530 篇
metadata:
  node_type: memory
  type: project
...
**来源**：`/tmp/design-study/auto-v5/design/` (686 篇, 去掉 1163 色卡) + `/tmp/design-study/auto-v6/design/` (139 篇, 清商业站后) = **824 篇**
**主题地图**：`/tmp/design-study/digest/topic_map_k30.md` (K=30，archive 价值保留)
**生成**：2026-06-07
**关联**：[MEMORY.md](MEMORY.md) 深读综合索引
...
- v5+v6 共 **824 篇** 被 LLM 分类器标为 DESIGN
- 其中约 **530 篇** 已按 15 个主题 cluster 深读或综合
...
1. **先查 [MEMORY.md](MEMORY.md) 的深读综合**——常见主题多半已有对应入口
2. **缺哪块** → 查本表看哪个主题未覆盖
...
- `/tmp/design-study/` = 18 MB（design 分类结果 + digest + 2 脚本）
